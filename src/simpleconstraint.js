            ...
            if (dim_s[0]==dim_a[0] && dim_s[1]==dim_a[1])
                {
                    ...
                    return {U: svd0.U, S: makeDiagonal(dim_a[0],dim_a[1], svd0.S), V: svd0.V};
            ...
            if (dim_s[0]==dim_a[0] && dim_s[1]==dim_a[1])
                {
                    ...
                    return {U: correct_U, S: Sd, V: correct_V};
                }
        console.log("A^T failed");
    }
    console.log("Solution 3:");
    var svdt=numeric.svd(numeric.transpose(A));
    var V=svdt.U; var U=svdt.V; //var _Sigma_A= svdt.S;
...
C_AttachLocation.prototype.getAttribs = function(){
	return [[this.shape1index, this.attrib],[this.shape2index, this.attrib]];
};
...
C3_AttachY.prototype.getAttribs = function(){
	return [[this.shape1index,this.attrib_y], [this.shape2index,this.attrib_y]];
};
...
C_AttachScale.prototype.getAttribs = function(){
	return [[this.shape1index,this.log_scale_attrib],[this.shape2index,this.log_scale_attrib]];
};
...
*/
    ...
    return {constr_list: constr_list, total_shapes_involved: total_shapeindexlist_involved };
}
...
var getShapeProperties = function(shape, attrib){
    ...
    var d = decomposeMatrix(shape.matrix);
    switch(attrib){
        case 'x': return d.translation.x;
        case 'y': return d.translation.y;
        case 'z': return d.translation.z;
        case 'sx': return d.scale.x;
        case 'sy': return d.scale.y;
        case 'sz': return d.scale.z;
        case 'ax': return d.rotation.x;
        case 'ay': return d.rotation.y;
        case 'az': return d.rotation.z;

        case 'lsx': return Math.log( d.scale.x )/Math.log(10);
        case 'lsy': return Math.log( d.scale.y )/Math.log(10);
        case 'lsz': return Math.log( d.scale.z )/Math.log(10);

        // not tested:
        case 'm0':  return shape.matrix[0];
        case 'm1':  return shape.matrix[1];
        case 'm2':  return shape.matrix[2];
        case 'm3':  return shape.matrix[3];
        case 'm4':  return shape.matrix[4];
        case 'm5':  return shape.matrix[5];
        case 'm6':  return shape.matrix[6];
        case 'm7':  return shape.matrix[7];
        case 'm8':  return shape.matrix[8];
        case 'm9':  return shape.matrix[9];
        case 'm10':  return shape.matrix[10];
        case 'm11':  return shape.matrix[11];
...
var setShapeProperties = function(shape, attrib, value){
    ...
    */
    ...
    switch(attrib){
        ...
        */
        case 'x': d.translation.x = value; break;
        case 'y': d.translation.y = value; break;
        case 'z': d.translation.z = value; break;
        case 'sx': var xs=value/d.scale.x; d.scale.x = xs; break;
        case 'sy': var ys=value/d.scale.y; d.scale.y = ys; break;
        case 'sz': var zs=value/d.scale.z; d.scale.z = zs; break;
        case 'ax': d.rotation.x = value; break; //_setGroupAngle([shape], value, 0, 0, false, true, true); break; //terrible very inefficient
        case 'ay': d.rotation.y = value; break; //_setGroupAngle([shape], 0, value, 0, true, false, true); break;
        case 'az': d.rotation.z = value; break; //_setGroupAngle([shape], 0, 0, value, true, true, false); break;

        case 'lsx': var xs=exp10(value)/d.scale.x; d.scale.x = xs; break;
        case 'lsy': var ys=exp10(value)/d.scale.y; d.scale.y = ys; break;
        case 'lsz': var zs=exp10(value)/d.scale.z; d.scale.z = zs; break;

        // not tested:
        case 'm0':  shape.matrix[0] = value; matrix_mode = true; break;
        case 'm1':  shape.matrix[1] = value; matrix_mode = true; break;
        case 'm2':  shape.matrix[2] = value; matrix_mode = true; break;
        case 'm3':  shape.matrix[3] = value; matrix_mode = true; break;
        case 'm4':  shape.matrix[4] = value; matrix_mode = true; break;
        case 'm5':  shape.matrix[5] = value; matrix_mode = true; break;
        case 'm6':  shape.matrix[6] = value; matrix_mode = true; break;
        case 'm7':  shape.matrix[7] = value; matrix_mode = true; break;
        case 'm8':  shape.matrix[8] = value; matrix_mode = true; break;
        case 'm9':  shape.matrix[9] = value; matrix_mode = true; break;
        case 'm10':  shape.matrix[10] = value; matrix_mode = true; break;
        case 'm11':  shape.matrix[11] = value; matrix_mode = true; break;
        /*
